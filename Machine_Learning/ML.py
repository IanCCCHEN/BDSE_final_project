...
# filename = dfdisconti.corr(method='kendall', min_periods=1)   # 想要印出的程式碼 

# Result ='kendall_train.csv' # 印出CSV.名稱  
# def OutputCSV():   
...
# 2.3.1 向前特徵選取法(Forward Feature Selection)： https://ithelp.ithome.com.tw/articles/10246251 
...
# 2.1.2(保留) 對資料進行標準化 sklearn.preprocessing.MinMaxScaler (保留)
