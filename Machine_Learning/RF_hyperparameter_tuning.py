...
#依照參數影響程度進行調參
# 模型調參https://zhuanlan.zhihu.com/p/126288078
...
# 调参，繪製學習曲線来调参n_estimators（對隨機森林影響最大）
score_lt = []

# 每隔10步建立一個隨機森林，獲得不同n_estimators的得分
